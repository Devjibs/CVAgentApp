...
namespace CVAgentApp.API.Migrations
{
    ...
    [Migration("20251008184050_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CVAgentApp.Core.Entities.DocumentSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CVAgentApp.Core.Entities.GeneratedDocument", b =>
                {
                    ...
                    b.HasOne("CVAgentApp.Core.Entities.DocumentSession", "Session")
                        .WithMany("GeneratedDocuments")
                        .HasForeignKey("SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CVAgentApp.Core.Entities.Session", null)
                        .WithMany("GeneratedDocuments")
